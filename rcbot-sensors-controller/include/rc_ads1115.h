...
#ifndef _RC_ADS_1115_H_
#define _RC_ADS_1115_H_
...
/*=========================================================================
    ...
    #define ADS1115_RESOLUTION              (16)                       //BITS
    #define ADS1115_MAX_READING_COUNT       ((pow(2, (ADS1115_RESOLUTION-1)))-1) // ACTUAL RESOULTION: 15 BITS; 1 BIT FOR POSITIVE/NEGATIVE
